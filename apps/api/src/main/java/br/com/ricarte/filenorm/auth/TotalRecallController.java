...
public class TotalRecallController {
    ...
    public TotalRecallController(AuthService authService, FilenormProperties properties) {
    ...
    public Map<String, Object> users(
        ...
        Account account = authService.provision(
                request.email(), request.name(), request.password(), request.expiresAt(), request.action());
